...
function insertItem(item, index) {
    ...
    <td class="acao">
      <button onclick="editItem(${index})"><img class="img" src="img/icons8-edit-64.png" alt="#"></button>
    </td>
    <td class="acao">
      <button onclick="deleteItem(${index})"><img class="img" src="img/icons8-excluir-50.png" alt="#"></button>
    </td>
  `
